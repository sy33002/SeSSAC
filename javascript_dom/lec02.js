...
console.log(h1.classList.contains('add-h1')); // true || false 반환
...
console.log(friends.children[0]); // 특정 자식 지칭
...
// <p> </p>> 만든거랑 같음
console.log(p);
p.innerText = '새로 추가된 p요소 입니다!'; // <p>새로 추가된 p 요소입니다~</p>
...
// x.appendChild(y): x요소의 맨 마지막 자식으로 y요소가 추가
div1.appendChild(p);// = container.append(p);
// appendChild는 여러개의 요소 추가가 불가능
...
const ul = firstLi.parentNode; //ul태그 선택됨
